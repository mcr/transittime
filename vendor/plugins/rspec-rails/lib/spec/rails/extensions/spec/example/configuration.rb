  ...
  module Example
    class Configuration
      ...
      if defined?(ActionController::Base)
        EXAMPLE_GROUP_CLASSES << ::Spec::Rails::Example::FunctionalExampleGroup
      	EXAMPLE_GROUP_CLASSES << ::Spec::Rails::Example::ControllerExampleGroup
	EXAMPLE_GROUP_CLASSES << ::Spec::Rails::Example::HelperExampleGroup
      end

      if defined?(ActionView::Base)
      	EXAMPLE_GROUP_CLASSES << ::Spec::Rails::Example::ViewExampleGroup
      end
